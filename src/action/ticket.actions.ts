...
export async function getTickets() {
    try {
        ...
        logEvent('Error feching tickets', 'ticktes', {}, 'error', error);
        return {}
    }
}
...
export async function getTicketById(id: string) {
    try {
        ...
        logEvent('Error fetching tickte details', 'ticket', { ticketId: id }, 'error', error);
        return null
    }
}


export async function closeTicket(prevState: {
    success: boolean,
    message: string

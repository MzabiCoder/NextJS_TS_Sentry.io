...
const Home = () => <main className='flex flex-col text-center items-center justify-center min-h-screen px-4'>
  ...
  <div className='animate-slide opacity-0 flex flex-col md:flex-row gap-4 justify-center'>
    <Link
      href='/tickets/new'
